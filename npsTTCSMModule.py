...
def costSurfaceMS(costSurfaceTable,
    ...
    try:
        ...
        count = 1
        for t in tableArray:
            if count + 1 == totalLines:             #If reached end of impedence Table exit loop, no more layers to overlay
                break
                

            elif count == 1:            #Loop for the intitial costSurface layer (Base layer) and first overlay
            ...
            elif count + 2 == totalLines: # Loop for the final cost surface overlay output is the final costSurface grid.
        ...
        if leastCostPathLC == "yes":
            ...
            for fid in fidList:
               ...
               # Process: Cost Path Calculation per individual destination
                gp.CostPath_sa(pathOut, travelTimeOut, backLine, pathOutImg , "EACH_CELL", "Id")  #Creating Individual Destination Cost Paths
                ...
                gp.AddField_management(costPathShp, "seconds", "LONG", "", "", "", "", "NON_NULLABLE", "NON_REQUIRED", "")
                gp.AddField_management(costPathShp, "minutes", "FLOAT", "", "", "", "", "NON_NULLABLE", "NON_REQUIRED", "")
                gp.AddField_management(costPathShp, "hours", "FLOAT", "", "", "", "", "NON_NULLABLE", "NON_REQUIRED", "")
                gp.AddField_management(costPathShp, "uniqueid", "TEXT", "", "", "20", "", "NON_NULLABLE", "NON_REQUIRED", "")
                ...
                gp.CalculateField_management(costPathShp, "seconds", inputLong, "PYTHON_9.3", "")
                gp.CalculateField_management(costPathShp, "minutes", "(!seconds!/ 60)", "PYTHON_9.3", "")
                gp.CalculateField_management(costPathShp, "hours", "(!seconds!/ 3600)", "PYTHON_9.3", "")
...
def travelTimeBackMS (startLocation,
    ...
    try:
        # Import system modules
        import sys, string, os, arcgisscripting, shutil, glob
        ...
        for dest in destList:
            ...
            if leastCostPathLC == "yes" and usePathDistanceLc == "yes":
                ...
                gp.CostPath_sa(startLocation, travelTimeBack, backLineBack, pathBackImg , "BEST_SINGLE", "Id")  #Creating Individual Destination Cost Paths
                # Process: Raster to Polyline...
                ...
                gp.CalculateField_management(costPathShp, "uniqueid", str(dest), "PYTHON_9.3", "")
